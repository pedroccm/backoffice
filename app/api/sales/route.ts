...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, message: 'Erro ao acessar a API de vendas', error: String(error) },
      { status: 500 }
    );
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Erro na API de vendas (POST):', error);
    return NextResponse.json(
      { success: false, message: 'Erro ao acessar a API de vendas', error: String(error) },
      { status: 500 }
    );
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('Erro na API de vendas (PUT):', error);
    return NextResponse.json(
      { success: false, message: 'Erro ao acessar a API de vendas', error: String(error) },
      { status: 500 }
    );
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Erro na API de vendas (DELETE):', error);
    return NextResponse.json(
      { success: false, message: 'Erro ao acessar a API de vendas', error: String(error) },
      { status: 500 }
    );
